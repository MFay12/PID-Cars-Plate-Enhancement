...
def buscar_placa_moto(img_original, img_colorida):
    ...
    for indice, candidato in enumerate(top_5):
        ...
        cv2.rectangle(img_debug, (x, y), (x + largura, y + altura), (255, 165, 0), 1)
        cv2.putText(img_debug, f"Teste #{indice + 1}", (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 165, 0), 1)
